...
public class MealRecord extends UpdatableRecordImpl<MealRecord> implements Record9<Long, BigDecimal, BigDecimal, BigDecimal, BigDecimal, BigDecimal, Long, Long, LocalDateTime> {
    ...
    @Override
    public Row9<Long, BigDecimal, BigDecimal, BigDecimal, BigDecimal, BigDecimal, Long, Long, LocalDateTime> fieldsRow() {
        return (Row9) super.fieldsRow();
    }

    @Override
    public Row9<Long, BigDecimal, BigDecimal, BigDecimal, BigDecimal, BigDecimal, Long, Long, LocalDateTime> valuesRow() {
    ...
    @Override
    public MealRecord values(Long value1, BigDecimal value2, BigDecimal value3, BigDecimal value4, BigDecimal value5, BigDecimal value6, Long value7, Long value8, LocalDateTime value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MealRecord(Long id, BigDecimal weight, BigDecimal protein, BigDecimal fat, BigDecimal carbohydrates, BigDecimal calories, Long foodId, Long dishId, LocalDateTime eatenOn) {
        super(Meal.MEAL);
